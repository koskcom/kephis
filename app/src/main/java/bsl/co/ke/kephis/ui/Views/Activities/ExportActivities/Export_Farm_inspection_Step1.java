...
public class Export_Farm_inspection_Step1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void postDataToSQLite() {
        ...
        farmInspectionBus.setSinspector(ssinspector);
    ...
    private class onNextClicked extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog mprogress = new ProgressDialog(Export_Farm_inspection_Step1.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    Intent intent = new Intent(Export_Farm_inspection_Step1.this, Export_Farm_inspection_Step2.class);

...
public class Export_Consignment_Inspection_Step1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consignment_inspection1_records);
    ...
    public void postDataToSQLite() {
        ...
        if (valid) {
            ...
            consignmentIspectionBus.setSsInspector(ssinspector);
    ...
    private class onNextClicked extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog mprogress = new ProgressDialog(Export_Consignment_Inspection_Step1.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    Intent intent = new Intent(Export_Consignment_Inspection_Step1.this, Export_Consignment_Inspection_Step2.class);

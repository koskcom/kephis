...
import bsl.co.ke.kephis.ui.Views.Activities.ExportActivities.ExportStepperAdapters.ConsignmentStepperAdapter;
...
public class ConsignmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stepperLayout.setAdapter(new ConsignmentStepperAdapter(getSupportFragmentManager(), this));

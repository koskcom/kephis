...
import bsl.co.ke.kephis.ui.Views.Activities.ExportActivities.ExportStepperAdapters.FarmStepperAdapter;
...
public class FarmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stepperLayout.setAdapter(new FarmStepperAdapter(getSupportFragmentManager(), this));
